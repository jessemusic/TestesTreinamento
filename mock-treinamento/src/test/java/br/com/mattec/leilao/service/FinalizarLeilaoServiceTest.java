...
import br.com.mattec.leilao.service.EnviadorDeEmails;
import br.com.mattec.leilao.service.FinalizarLeilaoService;
...
class FinalizarLeilaoServiceTest {
	...
	@Test
	void testaEmailParaVerSeOVencedorGanha() {
		List<Leilao> leiloes = leiloes();
	...
	@Test
	void naoDeveriaEnviarEmailParaOVencerSeErroNoLeilao() {
		List<Leilao> leiloes = leiloes();
	...
	private List<Leilao>  leiloes(){
		...
		Lance primeiro = new Lance(new Usuario("Beltrano"),
				new BigDecimal("600"));
		Lance sugundo = new Lance(new Usuario("Ciclano"),
				new BigDecimal("900"));
		
		leilao.propoe(primeiro);
		leilao.propoe(sugundo);
